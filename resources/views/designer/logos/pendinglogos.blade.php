                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3 d-flex justify-content-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Pending Logos</h3>
                                        </div>
                                        <div>
                                ...
                                <div class="nk-block">
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-sm-6 col-lg-4 col-xxl-3">
                                            <div class="gallery card card-bordered">
                                                ...
                                                @if($logo->media->directory_name != null || $logo->media->directory_name != "")
                                                    <a class="gallery-image popup-image" href="{{ asset('LogoDirectory/'.$logo->media->directory_name.'/'.$logo->media->directory_name.'.png') }}">
                                                        <img class="w-100 rounded-top" src="{{ asset('LogoDirectory/'.$logo->media->directory_name.'/'.$logo->media->directory_name.'.png') }}" alt="">
                                                    </a>
                                                @else
                                                    <a class="gallery-image popup-image" href="{{ asset('LogoDirectory/'.$logo->media->image_path) }}">
                                                        <img class="w-100 rounded-top" src="{{ asset('LogoDirectory/'.$logo->media->image_path) }}" alt="">
                                                    </a>
                                                @endif
                                                        ...
                                                        <div class="user-info">
                                                            <div class="card-head">
                                                                ...
                                                                <div class="approve-status">
                                                                    ...
                                                                    <?php }else{?>
                                                                        <span class="btn badge bg-danger" data-bs-toggle="modal" data-bs-target="#reasonForDisapproval-{{ $logo->id }}">Rejected</span>
                                                                    <?php }
                                                                    ?>
                                                                </div>
                                                            </div>
                                        ...
                                        @endforeach
                                        @if($logos->isEmpty())
                                        <p>You don't have any pending logos.</p>
                                        @endif                                        
                                    </div>
                                </div><!-- .nk-block -->
                            </div>
