...
@section('content')
      ...
      <div class="tab-wrapper">
        <div class="grid-wrapp">
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs1.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs2.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs3.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs4.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs5.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs6.png') }}" alt="">
          ...
          <div class="img__wrapper_boxs">
            <div class="img_logs">
              <img src="{{ asset('front/img/logs7.png') }}" alt="">
  ...
  <section class="join-logo-sec" style="background-image: url('{{ asset('front/img/signup-bg 1.png') }}');">
    <div class="container">
