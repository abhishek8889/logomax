                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between d-flex justify-content-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"> <a href="{{ url('internal-designer/dashboard/') }}">Internal Designer Dashboard </a></h3>
                            <div class="nk-block-des text-soft">
                                <p>Welcome to Internal Designer Dashboard</p>
                            </div>
                        </div>
                        <div>
                                        ...
                                        <tr class="tb-tnx-item">
                                            ...
                                            <td class="tb-tnx-amount is-alt">
                                                <div class="tb-tnx-total">
                                                    <span class="amount">{{ date_format($task->created_at,"d-m-Y"); }}</span>
                                                </div>
