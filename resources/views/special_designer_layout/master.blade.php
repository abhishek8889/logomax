...
<head>
    ...
    <title>Internal Designer Dashbaord</title>
    <!-- StyleSheets  -->
    ...
    <script type="module" src="{{ asset('/build/assets/specialdDsignerNotification-d4bfee4f.js?'.time()) }}"></script> 
            ...
            <div class="nk-sidebar nk-sidebar-fixed is-dark " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    ...
                    <div class="nk-sidebar-brand">
                        <a href="{{ url('internal-designer/dashboard/') ?? '' }}" class="logo-link nk-sidebar-logo">
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt"><a href="{{  url('internal-designer/dashboard/') }}">Internal Designer-Dashboard</a></h6>
                                </li>
                               @if(auth()->user()->role_id == 4)
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('internal-designer/task-list') }}" class="nk-menu-link">
                                                <span class="nk-menu-text">Pending Tasks</span>
                                            </a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('internal-designer/waiting-for-reply') }}" class="nk-menu-link"><span class="nk-menu-text">Waiting for Reply</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('internal-designer/complete-task') }}" class="nk-menu-link"><span class="nk-menu-text">Completed Tasks</span></a>
                                        </li>
                                    </ul>
                                </li>
                                @endif
                                <!-- <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <!-- <li class="nk-menu-item">
                                            <a href="{{url('special-designer/account-setting')}}" class="nk-menu-link"><span class="nk-menu-text">Account setting</span></a>
                                        </li> 
                                        <li class="nk-menu-item">
                                            <a href="{{ url('special-designer/account-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Change password</span></a>
                                        </li>
                                    </ul>
                                </li> -->
                                <!-- <li class="nk-menu-item ">
                                    <a href="{{-- url('internal-designer/messages') --}}" class="nk-menu-link ">
                            ...
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">
                                        ...
                                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status">Internal Designer</div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    <div class="user-avatar">
                                                        <span>{{ substr(Auth::user()->first_name,0,2) }}</span>
                                                    </div>
                                                    <div class="user-info">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    ...
                                                    <li><a href="{{ url('/internal-designer/account-setting') }}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
                                    ...
                                    <?php
                                        ...
                                        $newMessages = '';
                                        if(isset($messages)){
                                            $newMessages = $messages::where([['reciever_id',auth()->user()->id],['seen_status',0]])->distinct('sender_id')->pluck('sender_id');;
                                    ...
                                    <li class="dropdown notification-dropdown me-n1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end dropdown-menu-s1">
                                            <!-- <div class="dropdown-head">
                                                ...
                                                <a href="{{ url('internal-designer/messages/') }}">View</a>
                                            </div>-->
                                            <div class="dropdown-head">
                                            ...
                                            <div class="dropdown-body">
                                                ...
                                                @if($newMessages->isNotEmpty())
                                                   ...
                                                   <?php $unseen_messages = $messages::where([['reciever_id',auth()->user()->id],['sender_id',$message],['seen_status',0]])->get();
                                                    $user = App\Models\User::find($message);
                                                    $revisions = App\Models\LogoRevision::where([['assigned_designer_id',Auth::user()->id]])->whereHas('orderDetail',function($query) use ($message){ $query->where('user_id',$message); })->first();
                                                  
                                                   ?> <a href="{{ url('internal-designer/task-detail/'.$revisions->id) }}">
                                                    <div class="nk-notification-item dropdown-inner" >
                                                            <div class="nk-notification-icon">
                                                                <em class="icon icon-circle bg-warning-dim ni ni-curve-down-right"></em>
                                                            </div>
                                                            <div class="nk-notification-content">
                                                                <div class="nk-notification-text"><span>{{ count($unseen_messages) ?? 0 }} new message from {{ $user->first_name ?? '' }} {{ $user->last_name ?? '' }} </span></div>
                                                            </div>
                                                    </div>
                                                    </a>
                                                    @endforeach
