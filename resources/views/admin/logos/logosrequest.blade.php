                            ...
                            <div class="nk-content-body">
                                ...
                                <div class="nk-block">
                                    <div class="row g-gs">
                                        ...
                                        @endforeach
                                        @else
                                            <p>Currently there is no logo requests pending</p>
                                        @endif
                        ...
                        $('.statusbutton').on('click',function(e){
                            ...
                            if(action == 'deapproved'){
                                ...
                                $.ajax({
                                    ...
                                    data: { id:id,action:action,customer_price:customer_price,logo_type:logo_type,designer_price:designer_price,approved_status:status,_token:'{{ csrf_token() }}' },
