    ...
    <div class="card card-bordered card-preview">
        <div class="card-inner">
            <div class="preview-block">
                ...
                <!-- <hr class="preview-hr">
                <span class="preview-title-lg overline-title">Logos Prices</span>
               <form action="{{ url('admin-dashboard/update-site-setting') }}" method="post">
                @csrf
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="form-label" for="premiumprice">Premium Logo Price</label>
                            <input type="number" class="form-control focus" id="premiumprice" name="premium_price" placeholder="Premium Logo Price" value="{{ $premiumprice->meta_value ?? ''}}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="form-label" for="lowprice">Low Priced Logo Price</label>
                            <input type="number" class="form-control" id="lowprice" placeholder="Low Priced Logos" name="low_price" value="{{ $lowpricedlogoprice->meta_value ?? ''}}">
                        </div>
                    </div>
