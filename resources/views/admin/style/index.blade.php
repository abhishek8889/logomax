                       ...
                       <tr class="tb-tnx-item">
                           ...
                           <td class="tb-tnx-info text-center">
                               <div class="tb-tnx-desc">
                                ...
                                <div data-bs-toggle="modal" style_name="{{  $style->name ?? '' }}" style_id="{{ $style->id ?? '' }}" data-bs-target="#modalDefault" class="translate_btn btn btn-primary">Translate</div>
                               </div>
                           </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Style Name : {{ $style->name ?? '' }}</h5>
                    </div>
