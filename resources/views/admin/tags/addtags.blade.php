        ...
        <div class="col-lg-6 d-none" id="add-section">
                 <div class="card card-bordered h-100">
                     <div class="card-inner">
                         ...
                         <form action="{{ url('admin-dashboard/addtags/submitprocc') }}" method="POST">
                            @csrf
        ...
        <div class="nk-block nk-block-lg">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content d-flex justify-content-between">
                            <h4 class="nk-block-title">Tags List</h4>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                    <ul class="link-list-plain">
                                        <li><a class="edit-btn" tag-name="{{ $t->name ?? '' }}" tag-slug="{{ $t->slug ?? '' }}" tag-id="{{ $t->id ?? '' }}" href="{{ url('/admin-dashboard/categories-list/add-new/') }}/{{ $t->slug ?? '' }}">Edit</a></li>
                                        <li><a href="{{ url('/admin-dashboard/tags/delete') }}/{{ $t->id ?? '' }}">delete</a></li>
                                    </ul>
                                </div>
                            </div>
                           </td>
