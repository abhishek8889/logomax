...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-theme/assets/css/dashlite.css?ver=3.1.2asfasdfsdfg') }}">
    ...
    <script type="module" src="{{ asset('/build/assets/app-9b06d4ea.js?'.time()) }}"></script>
    <!-- <script src="{{-- asset('/build/assets/app-5eb7095a.js') --}}"></script>   -->
                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub" style="display: none;">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/prices') }}" class="nk-menu-link"><span class="nk-menu-text">Logos Prices</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li>
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub" style="display: none;">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/add-discount') }}" class="nk-menu-link"><span class="nk-menu-text">Add Discount</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/discount-list') }}" class="nk-menu-link"><span class="nk-menu-text">Discount List</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li>
                                <!-- ##########################  -->
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub" style="display: none;">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/site-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Site Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/about-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">About Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/support-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Support Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/reviews-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Reviews Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/blogs-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Blogs Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/login-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Login Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/register-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Register Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/shop-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Shop Page Setting</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/home-page-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Home Content</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/admin-dashboard/configuration/site-text-setting') }}" class="nk-menu-link"><span class="nk-menu-text">Site Text</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/configuration/terms-conditions') }}" class="nk-menu-link"><span class="nk-menu-text">Term & Conditions</span></a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub" style="display: none;">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/site-meta/support') }}" class="nk-menu-link"><span class="nk-menu-text">Add Support content</span></a>
                                ...
                                <ul class="nk-quick-nav">
                                    ...
                                    <div class="dropdown">
                                            <?php 
                                                ...
                                                $session_lang_code = Session::get('on_admin_lang_code');
                                                $curent_selected_lang = '';
                                            ?>
                                            @foreach($siteLanguagesList as $key=>$value)
                                                @if($key == $session_lang_code)
                                                    <?php  $curent_selected_lang = $value; ?>
                                                @endif
                                            @endforeach
                                        <a class="btn btn-secondary dropdown-toggle" href="#" type="button" data-bs-toggle="dropdown">{{ $curent_selected_lang }}</a>
                                        <div class="dropdown-menu">
                                            ...
                                            @foreach($siteLanguagesList as $key=>$value)
                                                <?php 
                                                    ...
                                                    $lang_name = $value;
                                                ?>
                                                <li><a href="{{ route('select.lang',['langCode'=>$lang_code]) }}"><span> {{ $value ?? '' }}</span></a></li>
                                            @endforeach
                                            </ul>
                                        </div>
                                    </div>
