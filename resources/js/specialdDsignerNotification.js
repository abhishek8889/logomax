...
window.Echo.channel('message'+userid)
        .listen('.messages',(e)=>{
           ...
           let html = '<div class="chat is-you"><div class="chat-content"><div class="chat-bubbles"><div class="chat-bubble"><div class="chat-msg">'+e.eventData.message+'</div></div></div><ul class="chat-meta"><li>'+e.eventData.userdata.first_name+' '+e.eventData.userdata.last_name+'</li><li>'+e.eventData.current_time+'</li></ul></div></div>';
