            ...
            if (Auth::attempt($data)) {
                ...
                if ((Auth::user()->role_id == 2 || Auth::user()->role_id == 3 || Auth::user()->role_id == 4 ) && Auth::user()->email_verified == 1) {
                    switch (Auth::user()->role_id) {
                        ...
                        case 2:
                            return redirect('/logo-designer-dashboard')->with('success', 'Welcome ' . Auth::user()->name . ' to Logo Designer Dashboard');
                        case 3:
                            return redirect('/admin-dashboard')->with('success', 'Welcome ' . Auth::user()->name . ' to Admin Dashboard.');
                        case 4:
                            return redirect('internal-designer/dashboard/')->with('success', 'Welcome ' . Auth::user()->name . ' to Internal Designer Dashboard');
                        default:
                            Auth::logout();
