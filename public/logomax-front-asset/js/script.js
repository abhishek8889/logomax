...
$('.fillter-slider').slick({
  ...
  nextArrow: '<button class="slide-arrow next-arrow"><i class="fa-solid fa-chevron-right"></i></i></button>',
...
$(document).ready(function () {
  $(".search_head").click(function () {
    $(this).next('.search_content').slideToggle();
...
$(document).ready(function(){
  $(".filter-title").click(function(){
    ...
    $(this).parents(".work_data").hide()
    $(this).hide()
    $(".closed-filter-wrap").addClass("fill-wrap")
    $(this).next(".filter-main-button").show()
    $(".filter-main-button").show()
    $(".site").removeClass("site_overly")
    $(".show_logo .row").addClass("fill_row")
    
  })
  $(".filter-collapse").click(function(){
    $(".show_logo .row").removeClass("fill_row")
    $(".site").addClass("site_overly")
  ...
  $(".site").click(function(){
    $(this).removeClass("site_overly")
    $(".work_data").hide()
  })
  $(".card").click(function(){
    $(this).toggleClass("card_open")
    $(this).siblings().removeClass("card_open")
  })
